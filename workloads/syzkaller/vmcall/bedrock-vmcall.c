...
//
// Identical ABI to the bitcoin workload's shutdown helper:
//   --ready  -> HYPERCALL_READY (7), signals boot/workload is up.
//   (none)   -> HYPERCALL_SHUTDOWN (0), powers the guest off.
